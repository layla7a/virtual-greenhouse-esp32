...
How to use
Edit the WiFi credentials and MQTT broker in the .ino file, flash to ESP32-CAM, open Serial Monitor at 115200 baud to get the IP address, then open that IP in your browser on the same WiFi network.
